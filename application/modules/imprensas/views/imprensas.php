...
<main class="main blog" role="main">
	<div class="content static">
		...
		<div class="three-fourth">
			<div class="row">
				<!-- Item -->
				<?php foreach ($imprensas as $key => $item): ?>
					
					<article class="one-half hentry">
						<figure><a href="<?php echo site_url('imprensas/detalhe/'.$item->slug); ?>"><img src="<?php echo site_url('userfiles/imprensas/'.$item->imagem); ?>" alt="<?php echo $item->titulo; ?>" /></a></figure>
						<div>
							<div class="text">
								<h3><a href="<?php echo site_url('imprensas/detalhe/'.$item->slug); ?>"><?php echo $item->titulo; ?></a></h3>
								<div class="meta">
									<span><?php echo $item->data_imprensa_f; ?></span>   
								</div>
								<p><?php echo ellipsize($item->resumo, 170); ?></p>
								<a href="<?php echo site_url('imprensas/detalhe/'.$item->slug); ?>" class="more" title="Read more">Saiba Mais</a>
							</div>
						</div>
					</article>
				<?php endforeach ?>
