				...
				<header id="header">
					...
					<nav class="nav-box">
						...
						<ul id="nav">
							...
							<li><a href="#" class="has-drop-down-a">Portfolio</a>
								<ul>
						...
						<select class="mobile-menu">
							...
							<option selected="selected" value="contact-1.php">- Contact Layout 1</option>
						...
						<div id="content">
							<div class="c1">
								...
								<article class="post-box">
									...
									<p>
										<iframe class="contact-page" src="http://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=New+York,+NY,+United+States&amp;sll=37.0625,-95.677068&amp;sspn=30.323858,86.572266&amp;ie=UTF8&amp;hq=&amp;hnear=New+York&amp;t=m&amp;ll=40.715973,-74.011374&amp;spn=0.098211,0.222988&amp;z=13&amp;output=embed"></iframe>
									</p>
									<?php
						...
						<aside id="sidebar">
							...
							<div class="widget">
								...
								<ul class="links-list">
									...
									<li><a class="dribbble" href="#">Dribbble Shots</a></li>
									<li><a class="youtube" href="#">Youtube Channel</a></li>
									<li><a class="google" href="#">Google+ Page</a></li>
									<li><a class="linkedin" href="#">Follow us on LinkedIn</a></li>
								</ul>
							</div>
							<!-- widget -->
							<div class="widget">
