    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form name="busca" id="busca" action="<?php echo site_url('quem_somos'); ?>" method="post">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-default" href="<?php echo site_url('quem_somos/limpar'); ?>">
                                Cancelar
                            </a>
                        </div>
                    </div>
                ...
                <table class="table table-striped middle-vertical-align">
                    ...
                    <tbody class="text-center" id="sortable">
                        <?php if ($quem_somos_lista): ?>
                            <?php foreach ($quem_somos_lista as $key => $quem): ?>
                                <tr id="<?php echo $quem->id ?>">
                                    ...
                                    <td align="center">
                                        <a href="<?php echo site_url('quem_somos/editar/'.$quem->id); ?>">Modificar</a>
                                    </td>
                                </tr>        
                            <?php endforeach ?>
                        <?php else: ?>
