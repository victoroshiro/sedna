...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<form method="post" action="<?php echo site_url('fidelidades/atualizar'); ?>" id="form_novidades" enctype="multipart/form-data">
				<input type="hidden" name="id" value="<?= $fidelidade->id ?>">
