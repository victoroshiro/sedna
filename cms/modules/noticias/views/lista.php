    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form name="busca" id="busca" action="<?php echo site_url('noticias'); ?>" method="post">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-default" href="<?php echo site_url('noticias/limpar'); ?>">
                                Cancelar
                            </a>
                        </div>
                    </div>
                ...
                <div id="acoes" class="text-right">
                    <div class="btn btn-danger" name="excluir-registros" data-module="noticias">
                        Excluir
                    </div>
                    <a class="btn btn-default" href="<?php echo site_url('noticias/cria'); ?>">                                    
                        Incluir
                    </a>
                </div>
                ...
                <table class="table table-striped middle-vertical-align">
                    ...
                    <tbody class="text-center" id="sortable">
                        <?php if ($noticias_lista): ?>
                            <?php foreach ($noticias_lista as $key => $noticia): ?>
                                <tr id="<?php echo $noticia->id ?>">
                                    <td class="selecao text-center">
                                        <input type="checkbox" name="" id="" value="<?php echo $noticia->id ?>" />
                                    </td>
                                    <td align="center" >
                                        <?php echo $noticia->data_noticia_f; ?>
                                    </td>
                                    <td align="center" >
                                    ...
                                    <td align="center">
                                        <a href="<?php echo site_url('noticias/editar/'.$noticia->id); ?>">Modificar</a>
                                    </td>
                                </tr>        
                            <?php endforeach ?>
                        <?php else: ?>
