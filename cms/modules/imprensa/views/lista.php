    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form name="busca" id="busca" action="<?php echo site_url('imprensa'); ?>" method="post">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-default" href="<?php echo site_url('imprensa/limpar'); ?>">
                                Cancelar
                            </a>
                        </div>
                    </div>
                ...
                <div id="acoes" class="text-right">
                    <div class="btn btn-danger" name="excluir-registros" data-module="imprensa">
                        Excluir
                    </div>
                    <a class="btn btn-default" href="<?php echo site_url('imprensa/cria'); ?>">                                    
                        Incluir
                    </a>
                </div>
                ...
                <table class="table table-striped middle-vertical-align">
                    ...
                    <tbody class="text-center" id="sortable">
                        <?php if ($press_lista): ?>
                            <?php foreach ($press_lista as $key => $press): ?>
                                <tr id="<?php echo $press->id ?>">
                                    <td class="selecao text-center">
                                        <input type="checkbox" name="" id="" value="<?php echo $press->id ?>" />
                                    </td>
                                    <td align="center" >
                                        <?php echo $press->titulo; ?>
                                    </td>
                                    <td align="center" >
                                        <?php echo $press->data_criacao; ?>
                                    </td>
                                    <td align="center">
                                        <a href="<?php echo site_url('imprensa/editar/'.$press->id); ?>">Modificar</a>
                                    </td>
                                </tr>        
                            <?php endforeach ?>
                        <?php else: ?>
